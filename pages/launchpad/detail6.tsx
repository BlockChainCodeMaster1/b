...
const LaunchpadDetails = () => {
    ...
    series: [
      {
        ...
        data: [
          { value: 21000000, name: 'Team' },
          { value: 105000000, name: 'IDO' },
          { value: 73500000, name: 'Ecosystem' },
          { value: 10500000, name: 'Cross-Chain Reserve' }
        ]
      }
    ]
  };
  ...
  const [tokenPrice, setTokenPrice] = useState('5.71 Sats');
  ...
  const setMax = async (value: number, type: number) => {
    ...
    if (type == 1) {
      setWhitelistInput(
        utils.formatUnits(
          utils.parseUnits(String('0.08'), 8).sub(utils.parseUnits(String(totalSale.data.totalBuy), 8)),
          8
        )
      );
    } else if (type == 2) {
          ...
          <div className={styles.swap}>
            <div className={styles.card + ' ' + styles.item}>
              <div className={styles.title}>
                <div>
                  <div className={styles.ori}>satoshiFlow</div>
                  <div>Whitelist Public Sale</div>
                </div>
                <div className={styles.deadline}>
                  {new Date().getTime() < 1700830800 * 1000 ? (
                    <Timer
                      formatValue={(value) =>
              ...
              <div className={styles.amount}>
                ...
                <div className={styles.list}>
                  ...
                  <div className={styles.val + ' ' + styles.ori}>{whitelistObtained} $SALW</div>
                </div>
              </div>
              {/* <Input
              ...
              <div className={styles.list + ' ' + styles.small}>
                ...
                <div className={styles.val + ' ' + styles.ori}>0.01 $BTC - 0.08 $BTC</div>
              </div>
            ...
            <div className={styles.card + ' ' + styles.item}>
              ...
              <div className={styles.amount}>
                ...
                <div className={styles.list}>
                  <div className={styles.label}>Number of tokens obtained</div>
                  <div className={styles.val + ' ' + styles.ori}>{obtained} $SALW</div>
                </div>
              </div>
              {/* <Input
                value={publicInput}
