  ...
  return (
    <HeaderFooter activeIndex={1}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.biis}>
          <a href="https://unisat.io/brc20/biis" target="_blank" rel="noreferrer" ><button className=""><span>Mint Now -&gt;</span></button></a>
          <a href="https://twitter.com/BisoSwap/status/1726443591177019422" target="_blank" rel="noreferrer" n>Learn -&gt;</a>
        </div>
